                ...
                >
                  ...
                  <div className="flex flex-col space-y-6 p-6 bg-white rounded-lg shadow-lg">
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-3 rounded-lg text-sm font-semibold transition ease-in-out duration-200 ${credential.notifications
                    ...
                    <button
                      ...
                      className={`w-full px-4 py-3 rounded-lg text-sm font-semibold transition ease-in-out duration-200 ${credential.isPublic
                        ? "bg-red-100 text-red-800"
                        : "bg-green-100 text-green-800"
                        }`}
                    >
