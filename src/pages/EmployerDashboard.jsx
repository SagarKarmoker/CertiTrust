    ...
    <div className="container mx-auto px-4">
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg mb-6">
        ...
        <div className="mb-4">
          ...
          <button
            ...
            className="mt-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-200 ease-in-out"
          >
            Add Stakeholder
          </button>
        </div>
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg mb-6">
        ...
        <button
          ...
          className="mt-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-2 px-6 rounded-lg shadow-md transition duration-200 ease-in-out"
        >
          Verify Credential
        </button>
      </div>
              ...
              {credentialData.sensitive && !permissions[credentialData.id] && (
                <div className="mt-4">
                  ...
                  <button
                    ...
                    className="mt-2 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-200 ease-in-out"
                  >
                    Request Permission
                  </button>
                </div>
